...
contract Investment {
    ...
    function claimInvestmentEthers(
        uint256 _id,
        uint256 _amount
    ) external payable {
    ...
    function getAllInvestableFarms()
        external
        view
        returns (FarmInvestmentDetails[] memory)
    {
    ...
    function getAllFarmInvestors(
        uint _farmId
    ) external view returns (Investors[] memory) {
